...
from utils import preprocess_words, Encoder, augment_permutations, preprocess_chars
...
def get_keras_model():
    max_features = 81
    model = Sequential()
    model.add(Embedding(max_features, 81, dropout=0.2))
...
class InputTransformer:
    ...
    def transform(self, X_train, y_train, augment):
        ...
        X_train = [preprocess_chars(ingredients, char_func) for ingredients in X_train]
